**Q1: Полезны ли такие технологии системному администратору с небольшим количеством
сотрудников ?**
...
**Q5: Рекомендации по железу. Особенно в части диска. И разделять ли сервер 1С и PostgreSQL.**

>   Что касается дисковой подсистемы:

-   если проект высоконагруженный, то в качестве backend, под саму базу
...
производительности, повышения компетенции администратора **и стабильности.**
...
**Q9: Обновление 1С сервера на 8.3.7 сразу, что это для заказчика, какие риски?**
...
**Q11: Столкнулись с тормозами ЗУП для Бюджета при проведении начислений. Что делать ?**
...
**Q14: Как настроить резервное копирование под Windows PG. Полное и частичное.**
...
**Q19: ZFS, BTRFS, XFS и другие FS под Linux и почему не TOAST (или в связке с TOAST)**
...
**Q27: Автовакуум в сборке от 1С включен по умолчанию? или его нужно врубать отдельно?**
...
**Q35: Почему вы не говорите про PostgreSQL HA Cluster c использованием Сorosync/Pacemaker**
...
**Q37: Как мигрировать между версиями ­ скажем между 9.1 и 9.4, через plain backup?**
...
**Q38: Где все таки скачивать дистрибутивы PostgreSQL под Windows и под Linux для 1С ?**
...
**Q39: Насколько будет эффективно развернуть виртуалку под linux на windows машине?**
...
**Q42: 1C сервер и PostgreSQL на одном физическом железе и операционке windows server 2012.**
